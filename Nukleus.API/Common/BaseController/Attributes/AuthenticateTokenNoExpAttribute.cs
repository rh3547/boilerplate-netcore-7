...
namespace Nukleus.API.Common.BaseController.Attributes
{
    ...
    public class AuthenticateTokenNoExpAttribute : Attribute, IFilterFactory
    {
        ...
        public IFilterMetadata CreateInstance(IServiceProvider serviceProvider)
        {
            ...
            return new AuthenticateTokenNoExpFilter(logger, jwtTokenProvider, environment);
        }
    }

    public class AuthenticateTokenNoExpFilter : IAuthorizationFilter
    {
        ...
        public AuthenticateTokenNoExpFilter(INukleusLogger logger, IJwtTokenService jwtTokenProvider, IWebHostEnvironment environment)
        {
            _logger = logger;
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!_jwtTokenProvider.VerifyToken(token, false).Result)
            {
                context.Result = UNAUTHORIZED_RESULT;
